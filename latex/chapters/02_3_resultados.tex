...
local do Or-Opt. A execução foi feita em um Acer Aspire A515-57, com CPU
Intel i5 12ª geração e 8GB RAM em um SO Debian 12.

\begin{table}[h!]
    \centering
    \caption{Execução das heurísticas}
    \label{tab:exec}
    \begin{tabular}{| c | c | c |}
        \hline
