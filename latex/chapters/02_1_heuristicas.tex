...
dinâmica e durante a etapa de compilação o tamanho do grafo, graças à macro \texttt{graph\_from\_csv} cujas particularidades serão abordadas na seção sobre o algoritmo genético/memético.
